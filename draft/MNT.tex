...
\begin{figure}[H]
	\centering
	\label{fig:twoSBM}
	\includegraphics[width=3in]{../Figure/twoSBM.pdf}
	\includegraphics[width =3in]{../Figure/twoSBM_diffusion.pdf}
	\caption{Estimated power based on $M = 500$ independently generated SBM presented in Eq.\ref{eq:twoSBM} (left) and estimated power according to diffusion time (right).}
\end{figure}
...
\begin{figure}[H]
	\centering
	\label{fig:ame}
	\includegraphics[width=3in]{../Figure/ThreeSBM.pdf}
	\includegraphics[width=3in]{../Figure/ThreeSBM_diffusion.pdf}
	\caption{Estimated power based on $M = 500$ independently generated SBM based on optimal neighborhood choices $(k,l)$ (left) and estimate power across diffusion time when sample size is $n=100$ (right). }
\end{figure}	
...
\begin{figure}[H]
	\centering
	\label{fig:dcSBM}
	\includegraphics[width=3in]{../Figure/dcSBM.pdf}
	\includegraphics[width=3in]{../Figure/dcSBM_diffusion.pdf}

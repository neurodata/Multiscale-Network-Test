...
\begin{figure}[H]
	\centering
	\label{fig:twoSBM}
	\includegraphics[width=4in]{../Figure/tmp_twoSBM.pdf}
	\caption{Estimated power based on $M = 500$ independently generated SBM presented in Eq.\ref{eq:twoSBM}.}
\end{figure}
...
\begin{figure}[H]
	\centering
	\label{fig:ame}
	\includegraphics[width=4in]{../Figure/tmp_ThreeSBM.pdf}
	\caption{Estimated power based on $M = 500$ independently generated SBM when \texttt{sample MGC} is used.}
\end{figure}	
